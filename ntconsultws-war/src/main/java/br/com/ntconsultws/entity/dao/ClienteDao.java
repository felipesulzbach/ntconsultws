...
public class ClienteDao extends BaseDao {
    ...
    public void salvar(EntityManager entityManager, Cliente cliente) throws Exception {
        if (cliente.getId() == null) {
            cliente.setId(burcarNovoId(entityManager));
        }
    ...
    private Long burcarNovoId(EntityManager entityManager) throws Exception {
        final Query query = entityManager.createNamedQuery("Cliente.findNextId");
